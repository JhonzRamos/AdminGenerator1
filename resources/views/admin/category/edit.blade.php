...
<div class="form-group">
    ...
    {!! Form::label('photo', 'Category Photo', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('photo', old('photo',$category->photo), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('description', 'Category Descriptions', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
