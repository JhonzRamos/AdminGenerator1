                   ...
                   <tbody>
                       @foreach ($products as $row)
                           <tr>
                               ...
                               <td>{{ $row->sProductDescription }}</td>


                               <td>
                                   {!! link_to_route(config('quickadmin.route').'.products.edit', trans('quickadmin::templates.templates-view_index-view'), array($row->id), array('class' => 'btn btn-xs btn-default')) !!}
