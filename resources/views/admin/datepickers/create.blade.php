...
{!! Form::open(array('route' => config('quickadmin.route').'.datepickers.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('sDateTimePicker', old('sDateTimePicker'), array('class'=>'form-control datetimepicker')) !!}
